    ...
    <div className="min-h-screen">
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="max-w-4xl mx-auto mb-20">
          <h2 className="text-3xl md:text-4xl font-bold mb-6 text-center">{t("about.storyTitle")}</h2>
        ...
        {/* Values Section */}
        <div className="mb-20">
          <h2 className="text-3xl md:text-4xl font-bold mb-12 text-center">{t("about.valuesTitle")}</h2>
